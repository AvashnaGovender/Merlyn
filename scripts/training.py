...
def train_duration_loop(buffer_size, lab_dim, num_epochs, warmup_epoch, train_dataloader, valid_dataloader, model, optimiser, criterion, reduce_lr, model_path, checkpoint_every_n, lr, duration = True ):
    ...
    for epoch in range(num_epochs):
        ...
        for idx, (x, t,ids, d, frames, dur_len) in enumerate(train_dataloader):
            ...
            if duration:
                ...
                x_in, t = x.to(device), d.to(device)
            ...
            if duration:
                ...
                mse_loss = criterion(y_pred.squeeze(), t)
        ...
        if reduce_lr:
            lr = lr * 0.5
            optimiser = optim.Adam(model.parameters(), cfg.lr)
        ...
        if epoch % checkpoint_every_n == 0:
            ...
            for idx, (x, t,ids, d, frames, dur_len) in enumerate(valid_dataloader):
                ...
                if duration:
                    ...
                    mse_loss = criterion(val_prediction.squeeze(), val_t)
...
if __name__ == '__main__':
    ...
    if cfg.TRAIN_DURATION:
        ...
        print('\n Starting training ...\n')
        train_loop(cfg.buffer_size, cfg.lab_dim, num_epochs, cfg.warmup_epoch , train_dataloader, valid_dataloader, duration_model, optimiser, criterion, cfg.reduce_lr, duration_model_path, cfg.checkpoint_every_n, cfg.lr )
    ...
    if cfg.TRAIN_ACOUSTIC:
        ...
        train_loop(cfg.buffer_size, cfg.lab_dim, num_epochs, cfg.warmup_epoch, train_dataloader, valid_dataloader, acoustic_model, optimiser, criterion, cfg.reduce_lr, acoustic_model_path, cfg.checkpoint_every_n, duration = False )
